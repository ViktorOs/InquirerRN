        ...
        <View style={styles.question} >
            ...
            <View style={styles.questionItem}>
                ...
                <View style={styles.questionRadioList}>
                    ...
                    {props.question.question_answers.map((item, key) =>
                        <Text style={[styles.questionRadio, isChecked === key ? styles.questionRadioChecked : '']} key={key} onPress={(e) => handleRadioChange(item.id, key)}>
                            {item.title}
                        </Text>
                    )}

...
export default function TypeRating(props){
    ...
    return (
        ...
        <View style={styles.question} >
            ...
            <View style={styles.questionItem}>
                ...
                <View style={styles.questionRatingList}>

                    {[...Array( 5 )].map((item, key) =>
                        <Text style={[styles.questionRadio, isChecked === key ? styles.questionRadioChecked : '']} key={key} onPress={(e) => handleRadioChange(key)}>
                            {key+1}
                        </Text>
                    )}
